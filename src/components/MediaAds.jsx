...
function TextAds() {
  ...
  return (
    <div sx={{ mt: 5 }}>
      <Typography variant="h2" sx={{ mt: 5, pt: 5 }} >Create Media Ad</Typography>
    ...
    width: "calc(100vw/3)"}}>
        ...
        <Grid item xs={12} style={{display:"flex",gap:"100px"}}>
          <Grid style={{display: "block",
    width: "calc(200vw/3)"}}>
            <Typography variant="h6">Bussines Name</Typography>
            <TextField label="Type something..." variant="outlined" fullWidth />
          </Grid>
          <Grid style={{display:"block",
    width: "calc(200vw/3)"}}>
            <Typography variant="h6">Bussines Lable</Typography>
            <TextField label="Type something..." variant="outlined" fullWidth />
          </Grid>
        </Grid>
